...
namespace PSK.Databases.LogisticsCRUD.Forms
{
    public partial class CourierListForm : Form
    {
        ...
        private void DataGridViewOnCellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView.CurrentRow?.DataBoundItem is CourierEntity customer
        ...
        {
            if (bindingSource.DataSource is BindingList<CourierEntity> customerList)
            {
                ...
                {
                    CourierRepository.Update(customerList[rowNumber]);
                }
